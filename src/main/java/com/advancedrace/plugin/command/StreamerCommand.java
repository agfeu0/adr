...
public class StreamerCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 2) {
            ...
            if (colorCode == null) {
                player.sendMessage(ChatColor.RED + "지원하는 색깔: red(빨강), orange(주황), yellow(노랑), dark_green(초록), green(연두), dark_blue(파랑), blue(파랑), light_blue(하늘), cyan(하늘), dark_aqua(어두운하늘), dark_purple(보라), magenta(분홍), gray(회색), black(검정), white(하양)");
                return false;
            }
        }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        // 2번째 인자일 때 색깔 목록 제공
            ...
            String[] colors = {
                ...
                "dark_blue", "blue", "light_blue", "cyan", "dark_aqua", "dark_purple", "magenta",
                "gray", "black", "white"
            };
